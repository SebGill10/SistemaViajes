...
namespace Sistema_Viajes.Migrations
{
    ...
    [Migration("20230425025359_Colaborador-AgregoSucursal")]
    partial class ColaboradorAgregoSucursal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sistema_Viajes.Models.Colaborador", b =>
                {
                    ...
                    b.Property<int>("SucurrsalId")
                        .HasColumnType("int");

                    b.HasKey("IdColaborador");

                    b.HasIndex("SucurrsalId");
            ...
            modelBuilder.Entity("Sistema_Viajes.Models.Colaborador", b =>
                {
                    b.HasOne("Sistema_Viajes.Models.Sucurrsal", "Sucurrsal")
                        .WithMany()
                        .HasForeignKey("SucurrsalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Sucurrsal");
                });
